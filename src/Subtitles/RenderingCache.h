...
public:
    ...
    bool Lookup(CAtlMap<K, POSITION, KTraits>::KINARGTYPE key, _Out_ typename VTraits::OUTARGTYPE value) {
        POSITION pos;
    ...
    POSITION SetAt(CAtlMap<K, POSITION, KTraits>::KINARGTYPE key, typename VTraits::INARGTYPE value) {
        POSITION pos;
        bool bFound = __super::Lookup(key, pos);
